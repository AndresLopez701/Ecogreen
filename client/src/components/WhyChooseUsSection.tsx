...
const WEDDING_IMG = "/images/wedding-outdoor.png";
...
function AnimatedCounter({ target, suffix }: { target: number; suffix: string }) {
  ...
  return (
    <span ref={ref} className="font-display text-5xl md:text-6xl font-bold tabular-nums">
      <span className="bg-gradient-to-b from-[#00D154] to-[#33E070] bg-clip-text text-transparent">
        {count}
      </span>
      <span className="text-[#00D154]/60">{suffix}</span>
    </span>
  );
}
  ...
  return (
    <section className="relative overflow-hidden" ref={ref}>
      ...
      <div className="relative py-24 md:py-32" ref={statsRef}>
        ...
        <div className="absolute inset-0 bg-[#0F1F14]/85 backdrop-blur-sm" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div className="w-8 h-px bg-gradient-to-r from-transparent via-[#00D154]/30 to-transparent mx-auto mt-4" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <div className="py-28 md:py-40 bg-[#F5F8F6] relative">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-[#00B140]/[0.02] blur-3xl" />
            ...
            {reasons.map((reason, i) => (
              ...
              >
                <GlassmorphismCard
                  ...
                  hoverGlow
                >
                  <div className="w-14 h-14 rounded-xl bg-[#00B140]/8 flex items-center justify-center mb-6 transition-all duration-500">
                    <reason.icon className="w-6 h-6 text-[#00B140]" />
                  </div>
                  <h3 className="font-display text-2xl font-semibold text-[#0F1F14] mb-3">
                    {reason.title}
                  </h3>
                  <p className="font-body text-base text-[#0F1F14]/55 leading-relaxed">
                    {reason.desc}
                  </p>
                </GlassmorphismCard>
              </motion.div>
