        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-7">
            ...
            >
              ...
              <a
                href="/ficha-tecnica.html"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 border border-[#D4A843]/60 hover:border-[#D4A843] text-[#D4A843] hover:text-[#E8C06A] font-body text-sm font-semibold px-8 py-4 rounded-full transition-all duration-300 bg-[#D4A843]/5 hover:bg-[#D4A843]/10 shadow-[0_0_20px_rgba(212,168,67,0.08)] hover:shadow-[0_0_30px_rgba(212,168,67,0.18)]"
              >
