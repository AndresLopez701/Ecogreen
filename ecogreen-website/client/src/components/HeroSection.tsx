...
// Mobile: 480p compressed videos (68KB each vs 4MB = 60x faster, still real videos)
const bgMobile = [
  "/imgs/bg-bodas-mobile.mp4",
  "/imgs/bg-eventos-mobile.mp4",
  "/imgs/bg-celebraciones-mobile.mp4",
  "/imgs/bg-fiestas-mobile.mp4",
];
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Mobile: 480p videos (68KB) | Desktop: full-res videos (4MB) */}
      {(mobile ? bgMobile : bgVideos).map((src, i) => (
        <motion.div
          key={src}
